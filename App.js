...
const PartnerNavigator = () => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    ...
    <Stack.Screen name="PartnerProductPhoto" component={PartnerProductDetailPhotoScreen} />
        <Stack.Screen name="PartnerTrackOrderScreen" component={PartnerTrackOrderScreen} />
        <Stack.Screen name="PartnerReturnOrderScreen" component={PartnerReturnOrderScreen} />
