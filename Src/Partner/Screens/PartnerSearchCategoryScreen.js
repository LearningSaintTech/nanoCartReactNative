...
import PartnerGenderTabs from '../../Partner/Components/PartnerGenderTabs';
...
const PartnerSearchCategoryScreen = () => {
  ...
  useEffect(() => {
    const fetchWishlist = async () => {
      ...
      try {
        ...
        console.log('📥 Fetching wishlist from:', `${BASE_URL}/partner/wishlist`);
  ...
  useEffect(() => {
    const fetchCart = async () => {
      ...
      try {
        ...
        console.log('📥 Fetching cart from:', `${BASE_URL}/partner/cart`);
...
export default PartnerSearchCategoryScreen;