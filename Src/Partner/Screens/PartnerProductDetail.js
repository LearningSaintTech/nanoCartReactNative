...
//             console.log('Token found:', token);
//             console.log(
//               'Quantities before constructing orderDetails:',
//               quantities,
//             );
...
//               Alert.alert(
//                 'Please select at least one size and set a quantity greater than 0.',
//               );
//               return;
//             }
...
//               console.log(
//                 `Using PPQ price for ${totalQuantity} items: ₹${pricePerPcs}`,
//               );
//             }
//             const totalPrice = totalQuantity * pricePerPcs;
...
//                 console.log(
//                   'Dispatched setCartItems with items:',
//                   data.data.items,
//                 );
  ...
  const handleAddToWishlist = async () => {
    ...
    try {
      const response = await fetch(
        'http://localhost:4000/api/partner/wishlist/create',
        {
          method: 'POST',
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      <View style={styles.bottomButtons}>
        ...
        <TouchableOpacity
          ...
          onPress={async () => {
            ...
            if (orderDetails.length === 0) {
              console.log('Order details empty, logging warning');
              console.warn(
                'Please select at least one size and set a quantity greater than 0.',
              );
              return;
